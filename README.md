...
- **Icon Theme**: [Tela circle black dark](https://github.com/vinceliuice/Tela-circle-icon-theme)
- **Interface Font**: [Inter Nerd Font](https://github.com/ayusshrathore/inter-nerd-font)
- **Terminal Font**: [SF Mono Nerd Font](https://github.com/shaunsingh/SFMono-Nerd-Font-Ligaturized)
